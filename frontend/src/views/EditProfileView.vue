<template>
  <div class="edit-profile-page container-fluid mt-4 mb-5 px-md-4">
    ...
    <n-grid x-gap="24" y-gap="20" cols="1 s:2" item-responsive responsive="screen"
            ...
            <template v-if="profileData.member_profile">
              ...
              <n-grid :x-gap="16" :cols="2">
                <n-form-item-gi label="性別" path="gender">
                  <n-select v-model:value="editableProfile.gender" :options="genderOptions" placeholder="選擇性別"
                            clearable/>
                </n-form-item-gi>
                <n-form-item-gi label="習慣位置" path="position">
                  <n-select v-model:value="editableProfile.position" :options="positionOptions" placeholder="選擇位置"
                            clearable/>
                </n-form-item-gi>
              </n-grid>
...
function populateForm(data) {
  ...
  if (data.member_profile) {
    ...
    editableProfile.organization_id = data.member_profile.organization?.id > 0 ? data.member_profile.organization.id : null;
  }
}
